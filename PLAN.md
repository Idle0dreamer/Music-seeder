...
legal canonical routes each for Ajam, Hijaz, and Nahawand, two each for Kurd
and Nikriz, and three for Rast: exact symbolic targets,
...
1. finish Bayati as the next complete profile, including phrase/cell
   ...
   evidence;
2. implement the remaining two root families—Bayati and Sikah—with separate
   root-jins, upper-jins, sayr, and modulation data; Ajam, Nahawand, Rast,
   Hijaz, Kurd, and Nikriz now establish the independent package seams;
